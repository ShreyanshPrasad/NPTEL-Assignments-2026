...
struct User* registerUser(struct User *head)
{
    ...
    /* Initialize follower and following lists */
    newUser->followerCount = 0;
    newUser->followingCount = 0;

    /* Add new user to the beginning of linked list */
    newUser->next = head;
...
int followUser(struct User *currentUser, struct User *otherUser)
{
    ...
    /* Add otherUser to currentUser's following list */
    currentUser->following[currentUser->followingCount] = otherUser;
    currentUser->followingCount++;

    /* Add currentUser to otherUser's followers list */
...
{
    /*
       Remove otherUser from currentUser's followers list.
    */
    ...
    {
        /*
           Remove currentUser from otherUser's following list.
        */
